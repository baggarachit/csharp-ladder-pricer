...
public double getBestPrice(double notional)
        ...
        {
            // Console.WriteLine("wjbw");
            string fix= "133=1.134698134=1000000135=1000000133=1.134698134=3000000135=3000000133=1.134908134=7000000135=7000000133=1.134918134=15000000135=15000000133=1.134918134=20000000135=20000000";
            // // parseFix(fix);
            Program obj = new Program();
            obj.parseFix(fix);
            Console.WriteLine(obj.getBestPrice(20));
            // Console.WriteLine("wjbw");
        }
    }
}